  ...
  */
  ...
  SQLiteFactory = {
    ...
    */
    ...
    closeDb: function(databaseName, success, error) {
      //if (databaseName.path in SQLitePlugin.prototype.openDBs) {
        delete SQLitePlugin.prototype.openDBs[databaseName];
        cordova.exec(null, null, "SQLitePlugin", "close", [{path: databaseName}]);
      //}
    }
  };
